...
// Configuration
// honestly no idea why it was decided to hardcode these variables
...
router.get("/discord/guildInfo", async (req, res) => {
...
router.get("/discord/roleInfo", async (req, res) => {
...
router.get("/discord/memberInfo", async (req, res) => {
...
router.get("/discord/connections/authorize", async (req, res) => {
...
router.get("/discord/connections/authorized", async (req, res) => {
